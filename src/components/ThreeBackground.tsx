...
const ThreeBackground = () => {
  ...
  useEffect(() => {
    ...
    // Vertex Shader - exact from AdCoach.et
    const vertexShader = `
      uniform float uTime;
    ...
    // Fragment Shader - exact from AdCoach.et
    ...
    console.log("✅ Shader particles initialized");
  ...
  return (
    <div 
      className="fixed top-0 left-0 w-full h-[120vh] overflow-hidden pointer-events-none transition-all duration-700"
      style={{ zIndex: 0 }}
    >
      <div
        ref={containerRef}
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-white/5 to-white/30 dark:from-black/60 dark:via-black/40 dark:to-black/70 pointer-events-none" />
    </div>
  );
};
